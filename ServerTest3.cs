...
{
    class ServerTest3 // IDK why but i made ServerTest3 in hopes of understanding the code and being able to alter MyWebServer but turns out IDK where to start so i just coppied it basically (just different file paths)
    {
        private TcpListener listener;
        private int port = 42069;

        public ServerTest3(int new_port = 42069)
        {
        ...
        {
            string ServerDir = Path.Combine(Directory.GetCurrentDirectory(), "ServerShit");
        ...
        {
            string ServerDir = Path.Combine(Directory.GetCurrentDirectory(), "ServerShit");  // added these two myself
            string DataDir = Path.Combine(ServerDir, "Data");
